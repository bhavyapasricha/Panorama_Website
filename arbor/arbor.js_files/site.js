...
(function($){
    ...
    var that = {
      init:function(pSystem){
        ...
        if (document.referrer.match(/echolalia|atlas|halfviz/)){
          // if we got here by hitting the back button in one of the PLATFORM, 
          // start with the PLATFORM section pre-selected
          that.switchSection('PLATFORM')
        }
      },
      resize:function(){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
         ...
         } else if ($.inArray(nearest.node.name, ['PANORAMA', 'COD[e]DIT', 'ILLUMINATI', 'PLATFORM']) >= 0) {
  ...
  var Nav = function(elt){
    ...
    var that = {
      init:function(){
        ...
        $('#ILLUMINATI dl:not(.datastructure) dt').click(that.reveal)
        that.update()
        return that
      },
      more:function(e){
      ...
      update:function(){
        ...
        switch (_path){
          ...
          $('#ILLUMINATI').fadeTo('fast',0, function(){
            $(this).hide()
        ...
        document.title = "PANORAMA"
          ...
          $('#ILLUMINATI').stop(true).css({opacity:0}).show().delay(333).fadeTo('fast',1)
                    
          $('#ILLUMINATI').find(">div").hide()
          $('#ILLUMINATI').find('#'+_path).show()
          document.title = "PANORAMA » " + _path
          break
        }
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"PANORAMA":{color:"red", shape:"dot", alpha:1}, 
      
             PLATFORM:{color:CLR.branch, shape:"dot", alpha:1}, 
